...
const Input: React.FC<InputProps> = (props) => {
    ...
    return (<div className={classnames}>
        ...
        {append && <div className="rt-input-group-append">{typeof (append) === 'string' ? <span className="rt-input-string">{append}</span> : <div className="rt-input-append-icon">{append}</div>}</div>}
